...
**Core Philosophy:** Shared intelligence, distributed presentation. A set of global singleton systems (RulesEngine, DataSourceManager, ThemeManager, etc.) provide shared intelligence and data processing, while individual cards focus solely on presentation and user interaction.
...
**Design Principles:**
- **Singleton Systems**: All intelligence (rules, data processing, themes) is shared
- **Minimal Card Logic**: Cards only handle presentation and user interaction
- **Explicit Over Magic**: Cards explicitly request what they need
- **Performance**: Entity caching provides 80-90% faster access with multiple cards
...
**Responsibilities:**
- Collect rules from all MSD and Simple card instances
...
**Lightweight entity tracking for Simple Cards** ⭐
...
**Used By:** All Simple Cards (SimpleButton, future Simple Cards)
...
**Important:** This is ONLY for MSD cards. Simple Cards use CoreSystemsManager instead.
...
- [Subsystems Overview](subsystems/README.md) - All singleton systems
- [Advanced Renderer Details](subsystems/advanced-renderer.md)
- [Rules Engine](subsystems/rules-engine.md)
- [DataSource System](subsystems/datasource-system.md)
- [MSD Flow Diagrams](diagrams/)
