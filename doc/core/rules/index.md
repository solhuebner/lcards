...
Rules are defined in content packs or directly in the LCARdS config helper. You manage them from the **Rules** tab in any card editor, or through the [Config Panel](../../configuration/config-panel.md).
