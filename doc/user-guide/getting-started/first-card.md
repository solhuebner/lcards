...
![Basic Header](../../../images/button_samples/lcards-header.png)

### Understanding the Code

```mermaid
graph TD
    Type[type: custom:lcards-elbow-card] --> Card[Tells HA to use<br/>LCARdS elbow card]
    CardType[lcards_card_type:<br/>lcards-header] --> Style[Specifies header style<br/>with elbow corner]
